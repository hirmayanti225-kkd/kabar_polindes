...
<body data-spy="scroll" data-target=".navbar-collapse">
                            ...
                            <div class="hello_slid">
                                <div class="slid_item">
                                    <div class="home_text ">
                                        ...
                                        <h3 class="text-white">- We Create a <strong>Concept</strong> into The Market -
                                        </h3>
                                    </div>
                    ...
                    <div class="main_business">
                        ...
                        <div class="col-md-6">
                            <div class="business_item sm-m-top-50">
                                ...
                                <p class="m-top-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit pellentesque
                                    eleifend in mi
                                    sit amet mattis suspendisse ac ligula volutpat nisl rhoncus sagittis cras suscipit
                                    lacus quis erat malesuada lobortis eiam dui magna volutpat commodo eget pretium
                                    vitae
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="port_item xs-m-top-30">
                                                <div class="port_img">
                                                    <img src="<?php echo base_url('') ?>assets/images/work-img1.jpg"
                                                        alt="" />
                                                    <div class="port_overlay text-center">
                                                        <a href="<?php echo base_url('') ?>assets/images/work-img1.jpg"
                                                            class="popup-img">+</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="port_item xs-m-top-30">
                                                <div class="port_img">
                                                    <img src="<?php echo base_url('') ?>assets/images/work-img2.jpg"
                                                        alt="" />
                                                    <div class="port_overlay text-center">
                                                        <a href="<?php echo base_url('') ?>assets/images/work-img2.jpg"
                                                            class="popup-img">+</a>
                                                    </div>
                                                </div>
                                                <div class="port_caption m-top-20">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="port_item xs-m-top-30">
                                                <div class="port_img">
                                                    <img src="<?php echo base_url('') ?>assets/images/work-img3.jpg"
                                                        alt="" />
                                                    <div class="port_overlay text-center">
                                                        <a href="<?php echo base_url('') ?>assets/images/work-img3.jpg"
                                                            class="popup-img">+</a>
                                                    </div>
                                                </div>
                                                <div class="port_caption m-top-20">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="port_item xs-m-top-30">
                                                <div class="port_img">
                                                    <img src="<?php echo base_url('') ?>assets/images/work-img4.jpg"
                                                        alt="" />
                                                    <div class="port_overlay text-center">
                                                        <a href="<?php echo base_url('') ?>assets/images/work-img4.jpg"
                                                            class="popup-img">+</a>
                                                    </div>
                                                </div>
                                                <div class="port_caption m-top-20">
                    ...
                    <div class="main_test fix">
                        ...
                        <div class="col-md-6">
                            <div class="test_item fix">
                                <div class="item_img">
                                    <img class="img-circle" src="<?php echo base_url('') ?>assets/images/test-img1.jpg"
                                        alt="" />
                        ...
                        <div class="col-md-6">
                            <div class="test_item fix sm-m-top-30">
                                <div class="item_img">
                                    <img class="img-circle" src="<?php echo base_url('') ?>assets/images/test-img2.jpg"
                                        alt="" />
                                    <i class="fa fa-quote-left"></i>
                                </div>
                    ...
                    <div class="widget_area">
                            ...
                            <div class="widget_item widget_latest sm-m-top-50">
                                ...
                                <div class="widget_latst_item m-top-30">
                                    <div class="item_icon"><img
                                            src="<?php echo base_url('') ?>assets/images/ltst-img-1.jpg" alt="" /></div>
                                ...
                                <div class="widget_latst_item m-top-30">
                                    <div class="item_icon"><img
                                            src="<?php echo base_url('') ?>assets/images/ltst-img-2.jpg" alt="" /></div>
                                    <div class="widget_latst_item_text">
                                        <p>Lorem ipsum dolor sit amet, consectetur</p>
                                        <a href="">21<sup>th</sup> July 2016</a>
                                    </div>
                                ...
                                <div class="widget_latst_item m-top-30">
                                    <div class="item_icon"><img
                                            src="<?php echo base_url('') ?>assets/images/ltst-img-3.jpg" alt="" /></div>
                                    <div class="widget_latst_item_text">
                                        <p>Lorem ipsum dolor sit amet, consectetur</p>
                                        <a href="">21<sup>th</sup> July 2016</a>
                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="widget_item widget_service sm-m-top-50">
                                <h5 class="text-white">Latest News</h5>
                                <ul class="m-top-20">
                                    <li class="m-top-20"><a href=""><i class="fa fa-angle-right"></i> Web Design</a>
                                    </li>
                                    <li class="m-top-20"><a href=""><i class="fa fa-angle-right"></i> User Interface
                                            Design</a></li>
                                    <li class="m-top-20"><a href=""><i class="fa fa-angle-right"></i> E- Commerce</a>
                                    </li>
                                    <li class="m-top-20"><a href=""><i class="fa fa-angle-right"></i> Web Hosting</a>
                                    </li>
                                    <li class="m-top-20"><a href=""><i class="fa fa-angle-right"></i> Themes</a></li>
                                    <li class="m-top-20"><a href=""><i class="fa fa-angle-right"></i> Support Forums</a>
                                    </li>
                                </ul>
                            </div><!-- End off widget item -->
                        </div><!-- End off col-md-3 -->
    ...
    <sc ript src="<?php echo base_url('') ?>assets/js/owl.carousel.min.js"></sc>
    ...
    <sc ript src="<?php echo base_url('') ?>assets/js/plugins.js"></sc>
